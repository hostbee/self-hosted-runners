...
tc qdisc replace dev "$br_name" parent 1:10 fq_codel memory_limit 1024Mb
tc qdisc replace dev "$br_name" parent 1:20 fq_codel memory_limit 1024Mb
tc qdisc replace dev "$br_name" parent 1:30 fq_codel memory_limit 1024Mb
